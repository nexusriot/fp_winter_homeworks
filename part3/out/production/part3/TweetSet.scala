...
class Empty extends TweetSet {
  ...
  def moreRetweetedThan(mostRetweeted: Tweet): Tweet = mostRetweeted
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = moreRetweetedThan(new Tweet("Stub", "Stub", -1))

  final def moreRetweetedThan(mostRetweeted: Tweet): Tweet = right.moreRetweetedThan(left.moreRetweetedThan(if (elem.retweets > mostRetweeted.retweets) elem else mostRetweeted))
